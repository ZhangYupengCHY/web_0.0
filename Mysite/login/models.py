...
class StationSalesOverall(models.Model):
    ...
    shop_sales = models.CharField(max_length=255, blank=True, null=True)
    spend_rate = models.CharField(max_length=255, blank=True, null=True)
    sale_rate = models.CharField(max_length=255, blank=True, null=True)
